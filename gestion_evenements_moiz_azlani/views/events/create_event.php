        ...
        <div class="container">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="titre" id="titre" placeholder="Entrez le titre de l'événement" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" placeholder="Décrivez votre événement..."></textarea>
                </div>
